...
{
    public const byte WearDetection = global::OppoPodsManager.Control.Oppo.Features.WearDetection.FeatureId;
    public const byte LegacyGameMode = GameMode.LegacyFeatureId;
    public const byte VoiceEnhancement = global::OppoPodsManager.Control.Oppo.Features.VoiceEnhancement.FeatureId;
    public const byte HearingEnhancement = global::OppoPodsManager.Control.Oppo.Features.HearingEnhancement.FeatureId;
    public const byte DualDevice = global::OppoPodsManager.Control.Oppo.Features.DualDevice.FeatureId;
    public const byte LongBattery = global::OppoPodsManager.Control.Oppo.Features.LongBattery.FeatureId;
    public const byte SpatialSound = global::OppoPodsManager.Control.Oppo.Features.SpatialSound.FeatureId;
    public const byte BassEngine = global::OppoPodsManager.Control.Oppo.Features.BassEngine.FeatureId;
    public const byte SpineHealth = global::OppoPodsManager.Control.Oppo.Features.SpineHealth.FeatureId;
    ...
    private static bool SupportsProtocol(DeviceCapability capability, string featureName)
        => featureName switch
        {
            "dual-device" => global::OppoPodsManager.Control.Oppo.Features.DualDevice.IsSupported(capability),
            "bass-engine" => global::OppoPodsManager.Control.Oppo.Features.BassEngine.IsSupported(capability),
            "voice-enhancement" => global::OppoPodsManager.Control.Oppo.Features.VoiceEnhancement.IsSupported(capability),
            "hearing-enhancement" => global::OppoPodsManager.Control.Oppo.Features.HearingEnhancement.IsSupported(capability),
            "long-battery" => global::OppoPodsManager.Control.Oppo.Features.LongBattery.IsSupported(capability),
            "wear-detection" => global::OppoPodsManager.Control.Oppo.Features.WearDetection.IsSupported(capability),
            "spine-health" => global::OppoPodsManager.Control.Oppo.Features.SpineHealth.IsSupported(capability),
            "spatial-sound" => global::OppoPodsManager.Control.Oppo.Features.SpatialSound.IsSupported(capability),
    ...
    public static byte[] BuildPayload(byte featureId, bool enabled)
        => featureId switch
        {
            DualDevice => global::OppoPodsManager.Control.Oppo.Features.DualDevice.BuildPayload(enabled),
            VoiceEnhancement => global::OppoPodsManager.Control.Oppo.Features.VoiceEnhancement.BuildPayload(enabled),
            HearingEnhancement => global::OppoPodsManager.Control.Oppo.Features.HearingEnhancement.BuildFeaturePayload(enabled),
            LongBattery => global::OppoPodsManager.Control.Oppo.Features.LongBattery.BuildPayload(enabled),
            WearDetection => global::OppoPodsManager.Control.Oppo.Features.WearDetection.BuildPayload(enabled),
            SpatialSound => global::OppoPodsManager.Control.Oppo.Features.SpatialSound.BuildPayload(enabled),
            SpineHealth => global::OppoPodsManager.Control.Oppo.Features.SpineHealth.BuildPayload(enabled),
