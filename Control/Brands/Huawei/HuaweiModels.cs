...
{
    public static HuaweiCapabilities Unknown { get; } = new("HUAWEI TWS", false, false, false, false, false, false, false, false, true, false);
}
    ...
    private static readonly IReadOnlyDictionary<HuaweiRoute, HuaweiCapabilities> Capabilities =
        new Dictionary<HuaweiRoute, HuaweiCapabilities>
        {
            [HuaweiRoute.FreeBuds3] = new("HUAWEI FreeBuds 3",
                ...
                SupportsWearDetection: false, HasChargingCase: true, UsesReportedEarbudAvailability: false),
            [HuaweiRoute.FreeBuds4E] = new("HUAWEI FreeBuds 4E",
                ...
                SupportsWearDetection: true, HasChargingCase: true, UsesReportedEarbudAvailability: false),
            ...
            [HuaweiRoute.FreeBudsPro5] = new("HUAWEI FreeBuds Pro 5",
                ...
                SupportsDiscreteAncLevels: false, SupportsAncDirectionDial: false,
                SupportsRfcommBattery: true, SupportsGestureConfiguration: false,
                SupportsWearDetection: false, HasChargingCase: true, UsesReportedEarbudAvailability: true),
            ...
            [HuaweiRoute.Eyewear] = new("HUAWEI Eyewear",
                ...
                SupportsDiscreteAncLevels: false, SupportsAncDirectionDial: false,
                SupportsRfcommBattery: true, SupportsGestureConfiguration: false,
                SupportsWearDetection: false, HasChargingCase: false, UsesReportedEarbudAvailability: false),
